class ToysController < ApplicationController
  ...
  # POST /toys.json
  def create
    @n_code = N_code.find(params[:n_code_id])
    @toy = @n_code.toys.create(params[:toy_params])

    respond_to do |format|
      if @toy.save
        format.html { redirect_to @toy, notice: 'Toy was successfully created.' }  #  <=======I think the problem is here
  ...
  private
    ...
    def toy_params
      params.require(:toy).permit(:document_number, :excerpts, :html_url, :type, :title, :n_code_id)
    end
end
