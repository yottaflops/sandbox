...
class ToysControllerTest < ActionController::TestCase
  ...
  test "should create toy" do
    assert_difference('Toy.count') do
      post :create, toy: { document_number: @toy.document_number, excerpts: @toy.excerpts, html_url: @toy.html_url, title: @toy.title, type: @toy.type }
    end
  ...
  test "should update toy" do
    patch :update, id: @toy, toy: { document_number: @toy.document_number, excerpts: @toy.excerpts, html_url: @toy.html_url, title: @toy.title, type: @toy.type }
    assert_redirected_to toy_path(assigns(:toy))
  end
